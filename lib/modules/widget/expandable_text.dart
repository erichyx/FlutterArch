...
// 来源于github上的，进行了少量修改
// https://github.com/wode0weiyi/flutter-components/blob/master/flutter_learn/lib/widgets/expandableText/tq_expandableText.dart
...
class ExpandableTextState extends State<ExpandableText> {
  ...
  void _toggleExpanded() {
    if (widget.onlyExpand && _expanded) return;
  ...
  Widget build(BuildContext context) {
    ...
    final linkColor =
        widget.linkColor ?? Theme.of(context).colorScheme.secondary;
